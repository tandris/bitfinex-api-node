...
Order.flags = {
  OCO: Math.pow(2, 14), // 16384
  POSTONLY: Math.pow(2, 12), // 4096
  HIDDEN: Math.pow(2, 6), // 64
  NO_VR: Math.pow(2, 19), // 524288
  POS_CLOSE: Math.pow(2, 9), // 512
  REDUCE_ONLY: Math.pow(2, 10) // 1024
}
